...
Use Mickey's right hand as minutes arrow and left - as seconds. For moving Mickey's hands you can use: more explanation:"""
import pygame
import datetime
...
background = pygame.image.load('D:/MEmu/mickeyclock.jpg')
second = pygame.image.load('D:/MEmu/secondhand.jpg')
minute = pygame.image.load('D:/MEmu/minuthand.jpg')
